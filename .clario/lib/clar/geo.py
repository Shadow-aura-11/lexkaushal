"""clar.geo -- Geospatial utilities for Clario refresh scripts.

Usage:
  from clar.geo import haversine, bbox, to_geojson_feature, to_geojson_collection
  from clar.geo import to_cesium_entities, grid_points, bearing, destination_point
"""
